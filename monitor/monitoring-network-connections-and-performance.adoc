...
---
= Supervisa los recursos de red y del sistema en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:nodes_menu.png["Menú nodos"]
...
+
image:traffic_classification_policies_main_screen_w_examples.png["Ejemplo de directiva de tráfico para gráfico"]

.. Para ver los gráficos que muestran las métricas de red asociadas a una política, selecciona el botón de opción situado a la izquierda de la política y luego selecciona *Métricas*.
