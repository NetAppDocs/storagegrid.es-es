...
---
= Supervisa la salud del sistema en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:health_status_card.png["Health status card - dashboard"]
...
Si hay una o más alertas activas, <<Ver las alertas actuales y resueltas,seleccione cada alerta>>siga las acciones recomendadas.
 ...
 a| 
image:icon_alert_green_checkmark.png["icono de alerta verde marca de verificación"]
 a| 
*Conectado*
...
. Para expandir los grupos de alertas, selecciona el símbolo de flecha hacia abajo image:icon_alert_caret_down.png["icono de signo de intercalación abajo"]. Para contraer alertas individuales en un grupo, selecciona el símbolo de flecha hacia arriba image:icon_alert_caret_up.png["Icono de signo de intercalación arriba"] o selecciona el nombre del grupo.
. Para mostrar alertas individuales en lugar de grupos de alertas, desactive la casilla de verificación *Alertas de grupo*.
. Para ordenar las alertas actuales o los grupos de alertas, selecciona las flechas arriba/abajo image:icon_alert_sort_column.png["Icono de flechas de ordenación"] en el encabezado de cada columna.
+
...
.. Para cerrar la ventana emergente, selecciona cualquier lugar fuera de la ventana emergente.
