...
---
= Ver y gestionar el panel de control en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:grid_manager_dashboard.png["Consola de Grid Manager"]
...
|===
Algunas de las tarjetas se pueden maximizar para facilitar su visualización. Selecciona el icono de maximizar image:icon_dashboard_card_maximize.png["Icono Maximizar"] en la esquina superior derecha de la tarjeta. Para cerrar una tarjeta maximizada, selecciona el icono de minimizar image:icon_dashboard_card_minimize.png["Icono Minimizar"] o selecciona *Close*.
...
image:dashboard_manage.png["Gestionar paneles"]
...
image:dashboard_configure.png["Configurar el panel de control"]
