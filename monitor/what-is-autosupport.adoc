...
---
= Conoce AutoSupport en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== ¿Qué es Digital Advisor?

Active IQ Digital Advisor (también conocido como Digital Advisor) es una solución basada en cloud que aprovecha el análisis predictivo y la sabiduría colectiva de la base instalada de NetApp. Sus evaluaciones continuas de riesgos, alertas predictivas, orientación prescriptiva y acciones automatizadas te ayudan a prevenir problemas antes de que ocurran, lo que lleva a una mejor salud del sistema y mayor disponibilidad del sistema.
