...
---
= Recopila archivos de registro de StorageGRID y datos del sistema
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Si el nodo de administración usado para iniciar la recopilación de registros se desconecta durante la recopilación, StorageGRID no conserva los resultados. Necesitas reiniciar el nodo y volver a iniciar la recopilación de registros después de que termine el reinicio.
...
NOTE: Puedes dejar en blanco el campo «Contraseña de aprovisionamiento» para realizar un reintento estándar, o puedes introducir la contraseña para volver a intentarlo usando SSH.
