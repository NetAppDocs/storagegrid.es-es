...
sidebar: sidebar 
keywords: ilm tab 
summary: 'La pestaña ILM proporciona información sobre las operaciones de gestión de la vida útil de la información (ILM).' 
---
= Ver la pestaña ILM de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:nodes_page_ilm_tab.png["Pestaña Nodes page ILM"]
