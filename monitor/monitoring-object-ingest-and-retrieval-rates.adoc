...
---
= Supervisa las operaciones del cliente S3 en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:nodes_storage_node_objects_help.png["captura de pantalla de Nodes > _Storage Node_ > Objects > attribute help"]
