...
---
= Ver la pestaña Hardware de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:nodes_page_hardware_tab_graphs.png["Página Nodes pestaña hardware"]
...
image:nodes_page_memory_usage_details.png["Página de nodos > Hardware > Detalles del uso de la memoria"]
...
+
image:nodes_page_overview_tab_extended.png["Descripción general de la página nodos ampliada"]
...
+
.. Consulta los gráficos de utilización de CPU y de uso de la memoria para determinar los porcentajes de utilización de CPU y de la memoria a lo largo del tiempo. Para mostrar un intervalo de tiempo diferente, selecciona uno de los controles situados encima del gráfico. Puedes visualizar la información disponible para intervalos de 1 hora, 1 día, 1 semana o 1 mes. También puedes establecer un intervalo personalizado, lo que te permite especificar rangos de fecha y hora.
+
image:nodes_page_hardware_tab_graphs.png["Gráficos de hardware"]
...
El estado de temperatura de la controladora de computación.
 ...
 a| 
Fuente de alimentación del controlador informático A
 a| 
El estado de la fuente de alimentación A del controlador de cómputo.



 a| 
Fuente de alimentación del controlador informático B
 a| 
El estado de la fuente de alimentación B del controlador de cómputo.
...
+
image:nodes_page_network_traffic_graph.png["Gráfico de tráfico de red de la página Nodes"]

+
.. Consulta la sección de interfaces de red.
+
image:nodes_page_network_interfaces.png["Nodes Page Network interfaces"]

+
Usa la siguiente tabla junto con los valores de la columna *Velocidad* en la tabla de interfaces de red para determinar si los puertos de red de 10/25 GbE del appliance se configuraron para usar el modo activo/de respaldo o el modo LACP.
...
.. Consulta la sección Comunicación en red.
+
...
+
image:nodes_page_storage_used_object_data.png["Almacenamiento usado: Datos de objetos"]

+
image:storage_used_object_metadata.png["Almacenamiento utilizado: Metadatos de objetos"]
...
+
image:nodes_page_overview_tab_services_appliance.png["Pestaña Nodes de la página Overview para el dispositivo de servicios"]
...
. Selecciona la pestaña *Hardware* para ver más información sobre el dispositivo.
+
...
+
image:nodes_page_hardware_tab_graphs_services_appliance.png["Página nodos gráficos de la pestaña hardware para el dispositivo de servicios"]

.. Desplázate hacia abajo para ver la tabla de componentes del aparato. La tabla contiene información como el nombre del modelo, el número de serie, la versión del firmware del controlador y el estado de cada componente.
+
[cols="1a,2a"]
|===
| En la tabla dispositivo | Descripción 
...
. Selecciona la pestaña *Red* para ver la información de cada red.
+
El gráfico tráfico de red proporciona un resumen del tráfico de red general.
...
.. Consulta la sección de interfaces de red.
+
Usa la siguiente tabla junto con los valores de la columna *Velocidad* en la tabla de interfaces de red para determinar si los cuatro puertos de red de 40/100 GbE del dispositivo se configuraron para usar el modo activo/de respaldo o el modo LACP.
...
. Selecciona la pestaña *Almacenamiento* para ver información sobre los dispositivos de disco y los volúmenes en el dispositivo de servicios.
