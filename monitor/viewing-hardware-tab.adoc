...
+
image:nodes_page_hardware_tab_for_appliance.png["Página nodos ficha hardware para el dispositivo"]
...
+
image:nodes_page_network_communication.png["Comunicación de red de página nodos"]
...
+
image:nodes_page_storage_tables.png["Tablas de almacenamiento de páginas de nodos"]
...
+
image:nodes_page_hardware_tab_services_appliance.png["Página nodos Ficha hardware para el dispositivo de servicios"]
...
.. Revise la sección Network interfaces.
+
image:nodes_page_hardware_tab_network_services_appliance.png["Página nodos ficha hardware Network Services Appliance"]
...
+
image:nodes_page_storage_tab_services_appliance.png["Página nodos ficha almacenamiento Servicios dispositivo"]
