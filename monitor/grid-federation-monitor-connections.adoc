...
---
= Supervisa las conexiones de federación de grid de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:grid-federation-connections-tab.png["Pestaña Conexiones de federación de grid"]
...
+
image:grid-federation-permitted-tenants-tab.png["Pestaña Inquilinos permitidos de federación de grid"]
...
+
image:grid-federation-permitted-tenants-tab-for-connection.png["grid-federation-allowed-tenants-tab-for-connection"]
...
+
image:grid-federation-certificates-tab.png["grid-federación-certificados-tab"]
