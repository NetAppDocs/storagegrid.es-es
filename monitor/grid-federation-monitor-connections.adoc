...
+
image:grid_federation_connections_tab.png["Pestaña Conexiones de federación de grid"]
...
+
image:grid_federation_permitted_tenants_tab.png["Pestaña Inquilinos permitidos de federación de grid"]
...
+
image:grid_federation_permitted_tenants_tab_for_connection.png["grid-federation-allowed-tenants-tab-for-connection"]
...
+
image:grid_federation_certificates_tab.png["grid-federación-certificados-tab"]
