...
---
= Crea aplicaciones de supervisión personalizadas para StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para consultar las operaciones de la API de métricas, incluida la lista completa de las métricas disponibles, accede al Grid Manager. En la parte superior de la página, selecciona el icono de ayuda y selecciona *API documentation* > *metrics*. image:help_api_docs_metrics.png["Sección Métricas de documentación de la API de ayuda"]
