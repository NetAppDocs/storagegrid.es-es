...
---
= Edita las reglas de alerta en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:alert_rules_edit_rule.png["Alertas > Editar regla"]
...
+
image:alert_rules_edit_revert_to_default.png["Reglas de alerta: Revertir una condición editada al valor predeterminado"]
