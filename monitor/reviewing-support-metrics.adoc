...
---
= Revisa las métricas de soporte de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:metrics_page.png["Página de métricas"]

. Para consultar los valores actuales de las métricas de StorageGRID y ver gráficos de la evolución de dichos valores a lo largo del tiempo, selecciona el enlace de la sección Prometheus.
+
...
. Para acceder a los paneles ya creados que contienen gráficos de las métricas de StorageGRID a lo largo del tiempo, selecciona los enlaces de la sección Grafana.
+
Aparece la interfaz de Grafana para el enlace seleccionado.

+
image:metrics_page_grafana.png["Página de métricas Grafana"]
