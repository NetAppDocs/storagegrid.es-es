...
Para obtener más información sobre la sintaxis de las consultas de Prometheus, consulta https://prometheus.io/docs/prometheus/latest/querying/basics/["Conceptos básicos sobre consultas"^].
...
+
image:nodes_page_network_traffic_graph.png["Gráfico Prometheus"]
