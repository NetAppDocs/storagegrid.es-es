...
+
Selecciona el icono con el signo más image:icon_plus_sign_black_on_white.gif["icono de más"] para añadir destinatarios.
...
NOTE: Si necesitas modificar la configuración del correo electrónico, selecciona el icono del lápiz image:icon_edit_tm.png["Icono Editar"] para actualizar este campo.
