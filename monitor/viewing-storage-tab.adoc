...
---
= Ver la pestaña StorageGRID Storage
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
La pestaña «Almacenamiento» se muestra para todos los nodos, cada sitio y toda la grid. Esta pestaña contiene la siguiente información:

Gráficos de uso del almacenamiento:: En los nodos de almacenamiento, cada sitio y toda la cuadrícula, la pestaña almacenamiento incluye gráficos que muestran cuánto almacenamiento han utilizado los datos de objetos y los metadatos de objetos a lo largo del tiempo.
...
image:nodes_storage_node_storage_tab.png["Nodos > Nodo de almacenamiento > pestaña Almacenamiento"]
