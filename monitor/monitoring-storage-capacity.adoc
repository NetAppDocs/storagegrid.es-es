...
NOTE: Para ver gráficos de estos valores, selecciona los iconos de gráficos en las columnas disponibles.
...
image:forecast_metadata_usage.png["Previsión de uso de metadatos por sitio"]
