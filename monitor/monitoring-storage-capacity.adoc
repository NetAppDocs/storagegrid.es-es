...
---
= Supervisa la capacidad de almacenamiento en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:dashboard_data_and_metadata_space_usage_breakdown.png["Desglose del uso del espacio de datos y metadatos"]
...
+
image:dashboard_storage_over_time.png["Gráfico de almacenamiento a lo largo del tiempo"]
...
+
image:nodes_deployment_storage_tab.png["Pestaña Nodes Deployment Storage"]
...
image:calculating_watermarks.gif["Dibujo conceptual para el espacio útil total"]
...
+
image:nodes_page_storage_used_object_data.png["Nodos almacenamiento de páginas datos de objeto usados"]
...
NOTE: Para ver gráficos de estos valores, haz clic en los iconos de gráficos image:icon_chart_new_for_11_5.png["Icono de gráfico"] en las columnas disponibles.

+
image:nodes_page_storage_tables.png["Objeto almacena tablas"]
...
image:forecast-metadata-usage.png["Previsión de uso de metadatos por sitio"]
