...
---
= Ejecuta diagnósticos en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* image:icon_alert_green_checkmark.png["Icono Alerta verde marca de verificación"] *Normal*: Todos los valores están dentro del rango normal.
* image:icon_alert_yellow_minor.png["Alerta de icono menor amarilla"] *Atención*: uno o varios de los valores se encuentran fuera del rango normal.
* image:icon_alert_red_critical.png["Alerta de icono Rojo crítico"] *Precaución*: Uno o varios de los valores están significativamente fuera del rango normal.
...
+
image:support_diagnostics_page.png["Página de diagnóstico de soporte"]

. Para obtener más información sobre un diagnóstico concreto, selecciona esa fila.
+
...
+
image:support_diagnostics_cpu_utilization.png["Ejemplo de valores de estado de diagnóstico"]
...
+
image:grafana_dashboard_nodes.png["Nodos de la consola de Grafana"]

. *Opcional*: Para ver un gráfico de la expresión de Prometheus a lo largo del tiempo, selecciona *Ver en Prometheus*.
+
Aparece un gráfico Prometheus de la expresión utilizada en el diagnóstico.

+
image:support_diagnostics_prometheus_png.png["Página de diagnóstico Prometheus de soporte"]
