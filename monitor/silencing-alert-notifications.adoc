...
---
= Silencia las notificaciones de alerta en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:alerts_silences_page.png["Página Alertas > Silencios"]
...
+
image:alerts_create_silence.png["Alertas > Crear silencio"]
