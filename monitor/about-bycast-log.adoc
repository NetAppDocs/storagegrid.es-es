...
sidebar: sidebar 
keywords: bycast, log 
summary: El archivo /var/local/log/bycast.log es el archivo principal para la resolución de problemas del software StorageGRID. Hay un archivo bycast.log para cada nodo de la red. El archivo contiene mensajes específicos de ese nodo de la red. 
---
= Conoce el StorageGRID bycast.log
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
