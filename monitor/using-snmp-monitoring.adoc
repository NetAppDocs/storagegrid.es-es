...
summary: 'Si desea supervisar StorageGRID mediante el protocolo simple de gestión de redes (SNMP), debe configurar el agente SNMP que se incluye con StorageGRID.' 
---
= Usa la monitorización SNMP en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
