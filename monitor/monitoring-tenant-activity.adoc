...
---
= Supervisa la actividad de los inquilinos en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:tenant_accounts_page.png["Página Cuentas de inquilino"]

. Si lo deseas, puedes Sign in en una cuenta de inquilino seleccionando el enlace de Sign in image:icon_tenant_sign_in.png["Icono de inicio de sesión del inquilino"] en la columna *Sign in/Copy URL*.
. Si lo deseas, copia la URL de la página de Sign in de un inquilino seleccionando el enlace de copiar URL image:icon_tenant_copy_url.png["Icono de URL de copia de inquilino"] en la columna *Sign in/Copy URL*.
...
+
image:tenant_accounts_example_csv.png["Ejemplo de cuentas de inquilino .csv"]
...
+
image:tenant_usage_modal.png["Uso de arrendatario modal"]
...
+
image:tenant_bucket_space_consumption_GM.png["Gráfico de barra de consumo del bloque de inquilinos"]
...
+
image:tenant_bucket_details_csv.png["Ejemplo de CSV de detalles de bloque de inquilinos"]
