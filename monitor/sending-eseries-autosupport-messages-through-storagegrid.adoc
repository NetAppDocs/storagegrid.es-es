...
* Tienes el link:../admin/admin-group-permissions.html["Permiso de acceso de administrador o de dispositivo de almacenamiento"].
...
+
image:autosupport_santricity_home_page.png["Página de inicio de AutoSupport SANtricity"]
...
+
image:autosupport_santricity_operations.png["Operaciones de AutoSupport SANtricity AutoSupport"]
...
+
image:autosupport_configure_delivery_santricity.png["AutoSupport configure el método de entrega de AutoSupport SANtricity"]
