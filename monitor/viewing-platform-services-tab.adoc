...
---
= Ver la pestaña de servicios de la plataforma StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:nodes_page_site_level_platform_services.gif["Servicios de plataforma en el nivel de sitio de Nodes"]
