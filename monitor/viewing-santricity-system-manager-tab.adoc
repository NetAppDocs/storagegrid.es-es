...
---
= Ver la pestaña SANtricity System Manager de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Para usar SANtricity System Manager para configurar un proxy para E-Series AutoSupport, consulta link:sending-eseries-autosupport-messages-through-storagegrid.html["Envíe los paquetes AutoSupport de E-Series a través de StorageGRID"].
...
image:nodes_page_santricity_tab.png["Pestaña Nodes page SANtricity"]
