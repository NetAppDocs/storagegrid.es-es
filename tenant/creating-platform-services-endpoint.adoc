...
|===
--
.Puntos de conexión de Webhook y Kafka
--
Comprueba la conexión TLS para los puntos finales de webhook o Kafka.
...
*Nota*: Los endpoints de Webhook no tienen esta opción.
