...
summary: Si tu cuenta de inquilino StorageGRID tiene el permiso Use grid federation connection, puedes usar la Tenant Management API para clonar manualmente las claves de acceso S3. 
---
= Clona claves de acceso S3 entre grids de StorageGRID usando la Tenant Management API
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Si tu cuenta de inquilino StorageGRID tiene el permiso *Usar conexión de federación de grid*, puedes usar la API de gestión de inquilinos para clonar manualmente las claves de acceso S3 del inquilino en el grid de origen al inquilino en el grid de destino.
...
+
image:grid-federation-post-current-user-replicate.png["Punto final POSTERIOR para replicar la propia clave de acceso"]
...
+
image:grid-federation-clone-access-key.png["La API de tenant Manager introduce valores para clonar la clave de acceso"]
...
+
image:grid-federation-post-other-user.png["Punto final POSTERIOR para replicar la clave de acceso de otro usuario"]
