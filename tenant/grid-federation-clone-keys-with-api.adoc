...
+
image:grid_federation_post_current_user_replicate.png["Punto final POSTERIOR para replicar la propia clave de acceso"]
...
+
image:grid_federation_clone_access_key.png["La API de tenant Manager introduce valores para clonar la clave de acceso"]
...
+
image:grid_federation_post_other_user.png["Punto final POSTERIOR para replicar la clave de acceso de otro usuario"]
