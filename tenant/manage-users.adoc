...
summary: 'Puedes crear usuarios locales y asignarlos a grupos locales para determinar a qué funciones pueden acceder estos usuarios. El Tenant Manager incluye un usuario local predefinido, llamado `root`, aunque puedes agregar y eliminar usuarios locales, no puedes eliminar al usuario raíz.' 
---
