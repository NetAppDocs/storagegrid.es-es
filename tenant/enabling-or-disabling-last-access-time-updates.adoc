...
summary: 'Cuando los administradores de la red crean las reglas de gestión del ciclo de vida de la información (ILM) para un sistema StorageGRID, pueden especificar, de forma opcional, que se utilice el tiempo de acceso más reciente a un objeto para determinar si dicho objeto debe trasladarse a una ubicación de almacenamiento diferente. Si usas un inquilino de S3, puedes aprovechar estas reglas habilitando las actualizaciones del tiempo de acceso para los objetos en un bucket de S3.' 
---
= Activar o desactivar las actualizaciones del tiempo de acceso en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
