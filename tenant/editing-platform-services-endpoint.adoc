...
---
= Edita un punto final de servicios de plataforma en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Para cambiar el nombre que se muestra para el punto final, selecciona el icono de edición image:icon_edit_tm.png["Icono Editar"].
