...
---
= Ver y editar los detalles del grupo de inquilinos en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:tenant_group_details.png["Ver detalles del grupo"]
...
+
.. Si lo deseas, selecciona el nombre que se muestra o el icono de edición image:icon_edit_tm.png["Icono Editar"] para actualizar el nombre que se muestra.
+
