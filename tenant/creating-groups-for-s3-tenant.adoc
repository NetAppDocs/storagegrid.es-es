...
+
Si tu cuenta de inquilino tiene el permiso *Utilizar conexión de federación de redes* y te encuentras en la red de origen del inquilino, el nuevo grupo se sincroniza con la red de destino del inquilino. *Correcto* aparece como estado de la sincronización en la sección Resumen de la página de detalles del grupo.
