...
---
= Especifica un URN para un endpoint de servicios de plataforma StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Opcionalmente, puedes incluir  `mysite` al especificar un endpoint de Kafka: `urn:mysite:kafka:::kafka-topic-name`
