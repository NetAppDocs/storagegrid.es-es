...
---
= Conoce StorageGRID branch buckets
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Estás almacenando datos en un bucket con control de versiones. Hubo una vulnerabilidad accidental que provocó que se incorporaran muchos objetos no deseados entre los momentos _T1_ y _T2_. Puedes crear un bucket de rama para los valores de tiempo de _Exclusión_, _T1_ y _T2_, y redirigir las operaciones de los clientes a ese bucket de rama. Así, solo los objetos incorporados antes de _T1_ y después de _T2_ estarán expuestos a los clientes.
...
También consulta link:../ilm/how-objects-and-delete-markers-are-deleted.html#delete-s3-versioned-objects["Cómo se eliminan los objetos con versiones de S3"].
