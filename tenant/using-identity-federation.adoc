...
image:tenant_shares_identity_federation.png["El inquilino comparte la Federación de identidades"]
...
+
image:ldap_service_type.png["Página Federación de identidades que muestra las opciones de tipo de servicio LDAP"]
...
+
image:identity_federation_test_connection.png["Solicitud de federación de identidades para validar el formato de nombre de usuario de enlace"]
