...
---
= Conoce la API de gestión de inquilinos de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* *s3-configurations*: Operaciones para recuperar las configuraciones globales de S3.
...
image:tenant_api_swagger_example.gif["Ejemplo que muestra la operación DE OBTENER grupos en la API de Swagger"]
