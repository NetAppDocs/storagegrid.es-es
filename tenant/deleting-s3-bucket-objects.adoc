...
---
= Eliminar objetos de un bucket S3 de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Si en un bucket está habilitado el control de versiones de objetos, la operación de eliminación de objetos no eliminará los marcadores de eliminación creados en StorageGRID 11.7 o versiones anteriores. Consulta la información sobre cómo eliminar objetos de un bucket en link:../ilm/how-objects-and-delete-markers-are-deleted.html#delete-s3-versioned-objects["Cómo se eliminan los objetos con versiones de S3"].
...
+
image:delete_bucket_objects_in_progress.png["captura de pantalla donde se muestran los objetos de bloque que se están eliminando"]
...
+
image:delete_bucket_objects_complete.png["captura de pantalla que muestra todos los objetos de cubo eliminados"]
