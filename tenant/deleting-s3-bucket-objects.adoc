...
+
image:delete-bucket-objects-in-progress.png["captura de pantalla donde se muestran los objetos de bloque que se están eliminando"]
...
+
image:delete-bucket-objects-complete.png["captura de pantalla que muestra todos los objetos de cubo eliminados"]
