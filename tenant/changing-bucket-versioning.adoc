...
---
= Cambiar el versionado de objetos para un bucket S3 en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:../ilm/how-objects-and-delete-markers-are-deleted.html["Cómo se eliminan los objetos y los marcadores de eliminación"]
