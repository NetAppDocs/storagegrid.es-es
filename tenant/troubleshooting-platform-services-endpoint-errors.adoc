...
---
= Soluciona errores en el punto final de los servicios de la plataforma StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. En la página de detalles del punto final, selecciona *Conexión*. Esta pestaña muestra únicamente el error más reciente de un punto final e indica cuánto tiempo hace que se produjo el error. Los errores que incluyen el icono de la X roja image:icon_alert_red_critical.png["Icono X rojo"] ocurrieron en los últimos 7 días.
