...
---
= Eliminar un bucket S3 de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
No puedes eliminar un bucket de S3 si contiene objetos, versiones de objetos no actuales o marcadores de eliminación. Para obtener información sobre cómo se eliminan los objetos versionados de S3, consulta link:../ilm/how-objects-and-delete-markers-are-deleted.html["Cómo se eliminan los objetos y los marcadores de eliminación"].
