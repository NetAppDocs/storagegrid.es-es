...
summary: Si a tu cuenta de inquilino se le asignó el permiso Use grid federation connection cuando se creó, puedes usar la replicación entre grids para replicar automáticamente objetos entre los buckets en la grid de origen del inquilino y los buckets en la grid de destino del inquilino. La replicación entre grids puede ocurrir en una o en ambas direcciones. 
---
= Administra la replicación entre grids en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:grid-federation-cgr-workflow.png["Flujo de trabajo de replicación entre grid"]
...
+
image:grid-federation-cross-grid-replication-client-deletes.png["imagen que muestra la supresión del cliente de réplica en ambas cuadrículas"]
