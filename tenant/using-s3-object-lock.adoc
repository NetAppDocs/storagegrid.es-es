...
* Permitir a los usuarios activar S3 Object Lock en los buckets existentes.
...
* Si es necesario, ponte en contacto con un administrador de grid para activar una de las siguientes opciones:
+
** Bloqueo global de objetos S3
** Permitir que se active S3 Object Lock para los buckets existentes


* Crear cubos con bloqueo de objetos S3 activado.
* Activar S3 Object Lock en los buckets existentes.
...
Más información link:../ilm/requirements-for-s3-object-lock.html#s3-object-lock-existing-buckets["Requisitos de S3 Object Lock"]
