...
---
= Conoce el servicio de replicación StorageGRID CloudMirror
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: La replicación de CloudMirror solo es compatible si el bucket de origen tiene habilitado S3 Object Lock y el endpoint es un bucket S3 de Amazon o de StorageGRID. La configuración de Object Lock no se replica en el endpoint del bucket.
