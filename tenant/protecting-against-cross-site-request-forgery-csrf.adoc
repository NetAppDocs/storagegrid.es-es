...
summary: 'Puedes ayudar a proteger StorageGRID frente a los ataques de falsificación de solicitudes entre sitios (CSRF) utilizando tokens CSRF para reforzar la autenticación que usa cookies.' 
---
