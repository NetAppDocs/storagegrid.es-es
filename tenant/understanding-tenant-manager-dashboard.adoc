...
---
= Panel de control de Tenant Manager en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:tenant_dashboard_with_buckets.png["Consola - Lista de bloques"]
...
+
image:tenant_dashboard_storage_usage_segment.png["Segmento de gráfico de barras"]
...
+
image:tenant_dashboard_buckets.png["Almacenes de panel de inquilinos"]
...
image:tenant_dashboard_endpoint_error.png["Panel que muestra el mensaje de punto final"]
