...
summary: Las solicitudes contradictorias de los clientes, como por ejemplo que dos clientes escriban en la misma clave, se resuelven según el principio de latest-wins. 
---
= Cómo la API de REST de StorageGRID S3 resuelve las solicitudes de clientes en conflicto
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
