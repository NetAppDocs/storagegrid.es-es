...
---
= Restaura un objeto en StorageGRID con la solicitud S3 RestoreObject
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
*Importante*: Si un objeto se ha trasladado a S3 Glacier Deep Archive o el Cloud Storage Pool utiliza Azure Blob Storage, no puedes restaurarlo usando el tier  `Expedited`. Se devuelve el siguiente error `403 Forbidden`, `InvalidTier`: `Retrieval option is not supported by this storage class`.
