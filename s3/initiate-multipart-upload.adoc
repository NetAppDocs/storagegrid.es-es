...
---
= Cabeceras y opciones de solicitud S3 CreateMultipartUpload en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Si la solicitud CreateMultipartUpload no especifica una suma de comprobación, StorageGRID no calcula una suma de comprobación CRC-64/NVME por defecto para un objeto. StorageGRID ignora valores inválidos o no compatibles `x-amz-checksum-algorithm`.
