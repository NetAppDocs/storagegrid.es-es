...
---
= Operaciones compatibles de la API de REST de S3 y limitaciones en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
El sistema StorageGRID admite tanto solicitudes de tipo «host virtual» como solicitudes de tipo «ruta».
