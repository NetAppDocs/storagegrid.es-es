...
summary: La solicitud PUT Bucket last access time te permite activar o desactivar las actualizaciones del tiempo de acceso para buckets individuales. 
---
= Activar y desactivar las actualizaciones del tiempo de último acceso en StorageGRID con la solicitud PUT Bucket last access time
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
