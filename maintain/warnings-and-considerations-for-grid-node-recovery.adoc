...
* Si estás recuperando un nodo de la red que no sea el nodo de administración principal, debe existir conectividad entre el nodo de la red que estás recuperando y el nodo de administración que gestiona el procedimiento de recuperación.
...
Si falla un servidor que aloja más de un nodo de la red, puedes recuperar los nodos en cualquier orden. Sin embargo, si el servidor que ha fallado aloja el nodo de administración principal y no existen nodos de administración secundarios, debes recuperar primero el nodo de administración principal.
