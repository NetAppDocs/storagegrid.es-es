...
Puedes identificar los nodos desconectados buscando el icono azul Unknown image:icon_alarm_blue_unknown.png["Icono desconocido"] o el icono gris Administratively down image:icon_alarm_gray_administratively_down.png["Icono administrativamente caído"] en la columna *Health*.
...
. Selecciona *Iniciar decomisionar*.
+
...
. Revisa la lista de nodos y selecciona *OK*.
+
...
. En cuanto esté disponible el nuevo paquete de recuperación, haz clic en el enlace o selecciona *Mantenimiento* > *Sistema* > *Paquete de recuperación* para acceder a la página del paquete de recuperación. Luego, descarga el archivo  `.zip`.
+
...
. Si vas a decomisionar un nodo de almacenamiento, supervisa el estado de las tareas de reparación de los *datos replicados* y los *datos con código de borrado (EC)* que se inician automáticamente durante el proceso de decomisionamiento.
+
[role="tabbed-block"]
====
.Datos replicados
...
--
Para supervisar la reparación de los datos con código de borrado y volver a intentar cualquier solicitud que pueda haber fallado, selecciona *Soporte* > *Herramientas* > *Métricas* para ver el tiempo estimado hasta la finalización y el porcentaje de finalización del trabajo actual. Luego, selecciona *EC Overview* en la sección de Grafana. Mira los paneles *Grid EC Job Estimated Time to Completion* y *Grid EC Job Percentage Completed*.
