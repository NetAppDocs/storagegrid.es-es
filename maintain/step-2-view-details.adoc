...
summary: 'En el paso 2 (Ver detalles) del asistente del sitio de decoración, puede revisar qué nodos están incluidos en el sitio, ver cuánto espacio se ha utilizado en cada nodo de almacenamiento y evaluar cuánto espacio libre está disponible en los otros sitios de la cuadrícula.' 
---
= Revisa los detalles del sitio antes de decomisionar en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:decommission_site_step_2_site_warnings.png["Advertencias de retirada del sitio paso 2"]
...
** El sitio contiene una combinación de nodos conectados (image:icon_alert_green_checkmark.png["Icono Alerta verde marca de verificación"]) y nodos desconectados (image:icon_alarm_gray_administratively_down.png["Icono alarma gris administrativamente abajo"] o image:icon_alarm_blue_unknown.png["Icono alarma azul desconocida"]). Antes de poder eliminar este sitio, debes volver a poner en línea todos los nodos que están fuera de línea.


. Revise los detalles sobre el sitio que ha seleccionado para eliminar.
+
image:decommission_site_step_2_view_details.png["Retirada del sitio Paso 2 Ver detalles"]
...
+
*** image:icon_alert_green_checkmark.png["Icono Alerta verde marca de verificación"] (Conectado)
*** image:icon_alarm_gray_administratively_down.png["Icono alarma gris administrativamente abajo"] (Fuera de servicio por motivos administrativos)
*** image:icon_alarm_blue_unknown.png["Icono alarma azul desconocida"] (Desconocido)
...
+
image:decommission_site_step_2_view_details_for_other_sites.png["Retirada del emplazamiento Paso 2 Ver detalles de otros sitios"]
