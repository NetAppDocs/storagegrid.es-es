...
---
= Restaura datos de objetos usando StorageGRID Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Has comprobado que el nodo de almacenamiento en el que estás restaurando los objetos presenta un estado de conexión *Conectado* image:icon_alert_green_checkmark.png["icono de alerta verde marca de verificación"] en la pestaña *Nodos* > *Resumen* del Grid Manager.
