...
---
= Agrega o cambia las listas de subredes en Grid Network en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:change_ip_tool_gnsl_sample_input.gif["captura de pantalla descrita por el texto circundante"]
...
+
image:change_ip_tool_gnsl_sample_output.gif["captura de pantalla descrita por el texto circundante"]
