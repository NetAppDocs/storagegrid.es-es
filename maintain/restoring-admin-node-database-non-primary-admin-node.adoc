...
---
= Restaurar la base de datos del nodo de administración StorageGRID al recuperar un nodo de administración no primario
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Datos históricos de atributos, que se usan en los gráficos de la página Nodes
