...
---
= Supervisa la instalación del dispositivo de servicios StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Pasos
. Para supervisar el progreso de la instalación, selecciona *Monitor installation* en la barra de menús.
+
