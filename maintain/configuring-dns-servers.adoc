...
summary: 'Puedes añadir, eliminar y actualizar servidores DNS, de modo que puedas utilizar nombres de host con dominio completo (FQDN) en lugar de direcciones IP.' 
---
= Configura servidores DNS en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Pasos
. Seleccione *Mantenimiento* > *Red* > *Servidores DNS*.
. Selecciona el icono de eliminación image:icon-x-to-remove.png["icono de eliminar"] junto a la dirección IP.
. Seleccione *Guardar*.
