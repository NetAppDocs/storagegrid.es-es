...
---
= Ver el estado actual de todos los servicios de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:storagegrid_status_output.gif["captura de pantalla de la salida del comando storage-grid"]
