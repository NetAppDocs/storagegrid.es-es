...
summary: Restaura las métricas de Prometheus al recuperar un nodo de administración principal usando un nodo de administración no principal. 
---
= Restaurar las métricas de Prometheus al recuperar un nodo de administración principal de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
