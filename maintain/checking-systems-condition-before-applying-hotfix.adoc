...
---
= Comprueba el estado del sistema antes de aplicar una corrección urgente de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Los nodos conectados tienen marcas de verificación verdes image:icon_alert_green_checkmark.png["icono de alerta verde marca de verificación"] en la página de Nodos.
