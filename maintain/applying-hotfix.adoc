...
---
= Aplica una corrección urgente en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:software_update_landing.png["Página de destino de la actualización del software"]
...
+
image:hotfix_choose_file.png["HotFix Elija Archivo"]
...
+
image:hotfix_progress_table.png["Tabla de progreso de Hotfix"]
...
+
image:approve_all_progresstable.png["Progreso de la revisión con el botón quitar"]
