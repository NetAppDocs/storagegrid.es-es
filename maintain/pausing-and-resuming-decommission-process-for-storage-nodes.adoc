...
---
= Pausar y reanudar el proceso de decomisionar los nodos de almacenamiento StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:decommission_nodes_procedure_paused.png["Procedimiento de retirada de nodos en pausa"]
