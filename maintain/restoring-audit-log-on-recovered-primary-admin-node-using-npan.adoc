...
summary: Restaura el registro de auditoría en el nodo de administración principal recuperado usando un nodo de administración no principal. 
---
= Restaura el registro de auditoría de StorageGRID en un nodo de administración principal recuperado
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
