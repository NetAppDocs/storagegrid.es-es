...
---
= Advertencias para la recuperación de la unidad del sistema de StorageGRID Storage Node
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Si este nodo de almacenamiento está en modo de mantenimiento de solo lectura para permitir la recuperación de objetos por parte de otro nodo de almacenamiento con volúmenes de almacenamiento defectuosos, recupera los volúmenes en el nodo de almacenamiento con volúmenes defectuosos antes de recuperar este nodo de almacenamiento defectuoso. Consulta las instrucciones para link:reviewing-warnings-about-storage-volume-recovery.html["recupere de un fallo en el volumen de almacenamiento donde la unidad del sistema esté intacta"].
