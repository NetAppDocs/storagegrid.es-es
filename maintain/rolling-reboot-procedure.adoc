...
---
= Realiza un reinicio progresivo de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
TIP: No puedes reiniciar un nodo si está desconectado de la grid. Las casillas de selección están desactivadas para los nodos con estos iconos: image:icon_alarm_gray_administratively_down.png["icono de signo de interrogación gris"] o image:icon_alarm_blue_unknown.png["icono de signo de interrogación azul"].
