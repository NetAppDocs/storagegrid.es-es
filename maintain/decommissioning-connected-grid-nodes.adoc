...
---
= Decomisionar nodos StorageGRID conectados
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Todos los nodos de la red tienen un estado Normal (verde) image:icon_alert_green_checkmark.png["icono de marca de verificación verde"]. Si ves uno de estos iconos en la columna *Health*, debes intentar resolver el problema:
+
[cols="1a,1a,3a"]
|===
| . | Color | Gravedad 
 ...
 a| 
image:icon_alarm_yellow_notice.gif["icono cuadrado amarillo"]
 a| 
Amarillo
 a| 
Aviso
 ...
 a| 
image:icon_alert_yellow_minor.png["icono de diamante naranja claro"]
 a| 
Naranja claro
 a| 
Menor
 ...
 a| 
image:icon_alert_orange_major.png["icono de diamante naranja oscuro"]
 a| 
Naranja oscuro
 a| 
Importante
 ...
 a| 
image:icon_alert_red_critical.png["icono rojo x"]
 a| 
Rojo
 a| 
Crítico
