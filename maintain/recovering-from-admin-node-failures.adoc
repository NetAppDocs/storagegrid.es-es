...
---
= Recuperación del nodo de administración primario o no primario en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Opciones
* link:recovering-from-primary-admin-node-failures.html["Recupera el nodo de administración principal usando el mismo nodo de administración principal"]
* link:recovering-from-primary-admin-node-failures-using-npan.html["Recupérate de fallos del nodo de administración principal usando un nodo de administración no principal"]
