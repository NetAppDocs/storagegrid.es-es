...
---
= Actualiza las subredes para la red Grid de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Pasos
. Seleccione *Mantenimiento* > *Red* > *Red de cuadrícula*.
. Selecciona el icono de eliminación image:icon_x_to_remove.png["icono de eliminar"] junto a la subred.
