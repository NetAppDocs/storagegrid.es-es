...
---
= Añadir o cambiar listas de subredes en la red de administración en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:change_ip_tool_aesl_sample_input.gif["ejemplo de la herramienta de cambio ip"]
...
+
image:change_ip_tool_aesl_sample_output.png["captura de pantalla descrita por el texto circundante"]
