...
summary: Restaura la base de datos del nodo de administración cuando recuperas un nodo de administración principal usando un nodo de administración no principal. 
---
= Restaura la base de datos del nodo de administración de StorageGRID cuando recuperas el nodo de administración principal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Añade la clave privada de SSH al agente de SSH. Escribe: `ssh-add`
...
.. Cuando ya no necesites el acceso sin contraseña a otros servidores, elimina la clave privada del agente SSH. Escribe: `ssh-add -D`
