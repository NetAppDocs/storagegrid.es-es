...
---
= Reemplazar un nodo Linux en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Si hay más de un nodo de grid alojado en un host físico o virtual con Linux, puedes recuperar los nodos de grid en cualquier orden. Sin embargo, si el nodo de administración principal está presente, debes recuperarlo primero para evitar que se detenga la recuperación de otros nodos de grid cuando intenten contactar al nodo de administración principal. Si no puedes recuperar primero el nodo de administración principal y hay disponible un nodo de administración no principal, puedes usar un nodo de administración no principal para recuperar los nodos en cualquier orden.
