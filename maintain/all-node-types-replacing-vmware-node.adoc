...
---
= Sustituye un nodo de VMware en StorageGRID por un nodo de recuperación
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nodos de administración
 a| 
link:recovering-from-admin-node-failures.html["Recuperación del nodo de administración primario o no primario en StorageGRID"]
