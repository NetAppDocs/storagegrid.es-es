...
---
= Realiza los pasos adicionales de recuperación del nodo StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:selecting-start-recovery-to-configure-non-primary-admin-node.html["Recupera el nodo de administración principal usando un nodo de administración no principal"]
