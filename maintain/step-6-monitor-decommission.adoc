...
summary: 'En el paso 6 (Supervisión de misión) del asistente de página Sitio de retirada, puede supervisar el progreso a medida que se quita el sitio.' 
---
= Supervisa el progreso de la descomisión de instalaciones en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:decommission_site_step_6_recovery_package.png["Paquete de recuperación del paso 6 del desmantelamiento del sitio"]
...
+
image:decommission_site_step_6_data_movement.png["Retirada del movimiento de datos del paso 6 del sitio"]
...
+
image:decommission_site_step_6_storage_node.png["Decomisión del nodo de almacenamiento Paso 6 del sitio"]
...
+
image:decommission_site_step_6_repair_cassandra.png["Retirar sitio Paso 6 reparar Cassandra"]
...
+
image:decommission_site_step_6_remove_configuration.png["Retirar la configuración del sitio Paso 6 Quitar"]
...
+
image:decommission_site_success_message.png["Mensaje de retirada del sitio correcta"]
