...
image:grid_manager_dashboard_and_menu.png["De Grid Manager"]

Para obtener una explicación de la información que aparece en cada tarjeta, selecciona el icono de ayuda image:icon_nms_question.png["icono de signo de interrogación"] para esa tarjeta.
...
El menú de ayuda image:icon_help_menu_bar.png["icono ayuda en la barra de menús"] permite acceder a:
...
* Usa link:../admin/grid-federation-overview.html["federación de grid"] para sincronizar la información de la cuenta del tenant y replicar los datos de objetos entre dos sistemas StorageGRID
...
* link:../monitor/configure-email-server.html["Configura el servidor de correo electrónico"]
...
* link:../admin/about-multi-admin-verify.html["Configura la verificación de varios administradores"]
...
* link:../monitor/configure-autosupport-grid-manager.html["Configure AutoSupport"]
