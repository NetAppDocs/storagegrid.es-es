...
summary: 'Usas la gestión del ciclo de vida de la información (ILM) para controlar la ubicación, la duración y el comportamiento de ingesta de todos los objetos en tu sistema StorageGRID. Las reglas de ILM determinan cómo StorageGRID almacena los objetos a lo largo del tiempo. Configuras una o varias reglas de ILM y luego las añades a una política de ILM.' 
---
