...
image:retrieve_data_flow.png["Recuperar"]
...
. El servicio LDR de origen devuelve los datos del objeto recuperado al servicio LDR consultado, y el sistema devuelve el objeto a la aplicación cliente.
