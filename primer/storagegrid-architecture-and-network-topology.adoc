...
Para obtener más información sobre la topología de red de StorageGRID, los requisitos y las comunicaciones de la grid, consulta link:../network/index.html["Directrices sobre redes"].
...
image:data_center_site_single.png["Sitio de un único centro de datos"]
...
image:data_center_sites_multiple.png["Sitio de varios centros de datos"]
...
image:grid_nodes_and_components.png["diagrama descrito por texto circundante"]

Los clientes S3 almacenan y recuperan objetos en StorageGRID. Otros clientes se usan para acceder a la interfaz de gestión de StorageGRID y, opcionalmente, para acceder al recurso compartido de auditoría. Además, StorageGRID puede enviar alertas por correo electrónico de forma opcional a través de un servidor SMTP externo.
...
Los objetos se pueden almacenar en StorageGRID en nodos de almacenamiento basados en software o en hardware, o en Cloud Storage Pools, que consisten en buckets S3 externos o contenedores de Azure Blob Storage.
