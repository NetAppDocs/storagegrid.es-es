...
Consulta link:../ilm/how-objects-and-delete-markers-are-deleted.html["Cómo se eliminan los objetos y los marcadores de eliminación"] para más información.
...
image:delete_data_flow.png["El cliente elimina el flujo de datos"]
...
image:automatic_deletion_data_flow.png["Flujo de datos de eliminación automática"]
