...
image:object_conceptual_drawing.png["Objeto"]
...
image:ilm_replication_make_2_copies.png["Crear regla de 2 copias"]
...
image:ec_three_sites_4_plus_2.png["Código de borrado tres Sitios 4 Plus 2"]
