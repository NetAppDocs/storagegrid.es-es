...
---
= Flujo de trabajo de configuración para usar StorageGRID con FabricPool
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Opcionalmente, configurelink:../admin/using-identity-federation.html["federación de identidades"] ylink:../admin/how-sso-works.html["inicio de sesión único"] .
