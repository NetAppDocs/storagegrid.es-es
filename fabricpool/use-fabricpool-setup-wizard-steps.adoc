...
. Si aparece en el panel de control el banner *FabricPool y asistente de configuración de S3*, selecciona el enlace que aparece en el banner. Si el banner ya no aparece, selecciona el icono de ayuda image:icon_help_menu_bar.png["Icono de ayuda"] en la barra de encabezado de Grid Manager y selecciona *FabricPool y asistente de configuración de S3*.
...
.Pasos
. Si lo deseas, selecciona el icono de copiar (image:icon_tenant_copy_url.png["icono de copia"]) para copiar tanto el ID de la clave de acceso como la clave de acceso secreta al portapapeles.
+
