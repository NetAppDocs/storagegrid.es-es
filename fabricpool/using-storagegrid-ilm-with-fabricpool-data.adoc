...
* Si has actualizado a StorageGRID 12.1 desde una versión anterior a la 11.7, ya habrás configurado el grupo de almacenamiento que vas a utilizar. En general, deberías crear un grupo de almacenamiento para cada sitio de StorageGRID que vayas a usar para almacenar datos. (A partir de la versión 11.7, los grupos de almacenamiento se crean automáticamente para cada sitio.)
+
