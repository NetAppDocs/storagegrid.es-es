...
summary: 'Al configurar StorageGRID para su uso con FabricPool, puedes crear opcionalmente uno o más grupos de alta disponibilidad (HA).' 
---
= Crea un grupo de alta disponibilidad (HA) para FabricPool en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
