...
---
= Crea una cuenta de arrendatario para FabricPool en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Si lo deseas, selecciona *Usar conexión de federación de grid* para permitir que el inquilino utilice un link:../admin/grid-federation-overview.html["conexión de federación de grid"] para la sincronización de cuentas y la replicación entre grids. Luego, selecciona la conexión de federación de grid que quieres usar.
