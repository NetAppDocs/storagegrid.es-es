...
---
= Configura las entradas del servidor DNS para StorageGRID con FabricPool
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Entradas DNS para solicitudes de tipo «host virtual»

Si has definido link:../admin/configuring-s3-api-endpoint-domain-names.html["Nombres de dominio de punto final S3"] y vas a utilizar solicitudes de tipo virtual-hosted, añade entradas DNS para todos los nombres de dominio de los puntos finales de S3 necesarios, incluidos los nombres comodín.
