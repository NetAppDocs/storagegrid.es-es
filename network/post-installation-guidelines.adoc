...
CAUTION: Los nodos se reinician cuando DHCP cambia la configuración de red de grid, lo que puede provocar interrupciones si un cambio de DHCP afecta a varios nodos al mismo tiempo.
