...
---
= Obtenga información sobre cómo ampliar su sistema StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Obtenga información sobre cómo ampliar su sistema StorageGRID para aumentar la capacidad o las capacidades sin interrumpir las operaciones. Puede agregar volúmenes de almacenamiento a nodos de almacenamiento existentes, agregar nuevos nodos de red a un sitio existente o agregar un sitio nuevo.
