...
---
= Prepárese para expandir su sistema StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["Notas de la versión"^]. Debes iniciar sesión con tu cuenta de NetApp o crear una cuenta para acceder a las notas de la versión.
* link:../swnodes/index.html["Instrucciones de instalación para su plataforma"]
...
. Si está expandiendo un sistema RHEL, seleccione los archivos apropiados.
