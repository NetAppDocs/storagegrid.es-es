...
---
= Agregue volúmenes de almacenamiento a su sistema StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:nodes_page_storage_tables_vol_expansion.png["Tablas de almacenamiento de páginas de nodos"]
