...
---
= Implementar nuevos nodos de red en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Si necesitas acceder manualmente a la página de instalación de Monitor, selecciona *Monitor Installation* en la barra de menús.
+
La página de instalación de Monitor muestra el progreso de la instalación.
