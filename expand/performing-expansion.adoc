...
---
= Realizar una expansión de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Pasos
. Selecciona *Mantenimiento* > *Tareas* > *Ampliación de la red*.
+
Aparece la página de expansión de The Grid. La sección Nodos pendientes muestra los nodos que están listos para ser añadidos.
...
+
image:grid_node_details.png["Captura de pantalla de detalles del nodo de cuadrícula"]
...
. Cuando hayas aprobado todos los nodos de la red, introduce la *frase de contraseña de aprovisionamiento* y selecciona *Expand*.
+
