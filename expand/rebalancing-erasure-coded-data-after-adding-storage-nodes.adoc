...
summary: Después de añadir los nodos de almacenamiento, puedes usar el procedimiento de reequilibrio de código de borrado para redistribuir los fragmentos codificados con código de borrado entre los nodos de almacenamiento existentes y los nuevos. 
---
= Reequilibre los datos codificados por borrado después de agregar nodos a su sistema StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** Los datos de todos los nodos se encuentran dentro de una desviación del 5 % respecto a la partición del espacio útil previsto.
...
+
La tarea de reequilibrio de EC se considerará completada y se detendrá cuando el espacio utilizable en todos los nodos se encuentre dentro de una desviación del 5 % respecto a la partición de espacio utilizable objetivo.
...
+
El espacio útil debería estar ahora más equilibrado entre los nodos de almacenamiento del sitio.
