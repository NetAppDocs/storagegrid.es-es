...
---
= Agregue o actualice subredes a la red Grid para expansión en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Por ejemplo, no utilices los siguientes rangos de subred para la Grid Network, Admin Network o Client Network de ningún nodo:
