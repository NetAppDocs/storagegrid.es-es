...
---
= Configurar nodos y sitios recién agregados en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Si el inicio de sesión único (SSO) está habilitado para tu sistema StorageGRID, crea una relación de confianza de parte confiable para el nuevo nodo de administración. No puedes iniciar sesión en el nodo hasta que crees esta relación de confianza de parte confiable. Consulta cómo configurar el SSO usando link:../admin/learn-about-setting-up-sso-oidc.html["OIDC"] o link:../admin/learn-about-setting-up-sso-saml.html["SAML"].
