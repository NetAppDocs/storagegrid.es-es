...
summary: Puedes usar VMware OVF Tool para automatizar el despliegue de nodos grid en StorageGRID. También puedes automatizar la configuración de StorageGRID. 
---
= Automatiza el despliegue de nodos grid en StorageGRID con VMware vSphere
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Tiene VMware OVF Tool instalado y configurado correctamente.
