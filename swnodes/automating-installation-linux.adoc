...
summary: Puedes automatizar la instalación del servicio host StorageGRID y la configuración de los nodos grid en Linux. 
---
= Automatiza la instalación del servicio host de StorageGRID y la configuración de los nodos grid en Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
