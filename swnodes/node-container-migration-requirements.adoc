...
---
= Requisitos de migración de contenedores de nodo StorageGRID para Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:eth0_bond.gif["Esta imagen se explica por el texto circundante."]
...
image:block_device_mapping_rhel.gif["Mapeo de dispositivos de bloque"]
