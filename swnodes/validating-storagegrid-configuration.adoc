...
---
= Valida la configuración de StorageGRID en Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:rhel_node_configuration_file_output.gif["Esta imagen se explica por el texto circundante."]
...
image:rhel_node_configuration_file_output_with_errors.gif["Esta imagen se explica por el texto circundante."]
