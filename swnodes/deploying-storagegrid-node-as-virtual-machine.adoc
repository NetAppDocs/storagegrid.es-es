...
---
= Implementa nodos grid como máquinas virtuales para StorageGRID con VMware vSphere
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Es posible que tengas que reasignar un puerto si las políticas de red empresarial restringen el acceso a uno o varios puertos que utiliza StorageGRID. Consulta link:../network/index.html["Directrices sobre redes"] para conocer los puertos que utiliza StorageGRID.
