...
---
= Confirma las ubicaciones de los datos de objetos en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:object_lookup.png["Página Búsqueda de objetos"]
...
+
image:object_lookup_results.png["Resultados de la búsqueda de objetos"]
