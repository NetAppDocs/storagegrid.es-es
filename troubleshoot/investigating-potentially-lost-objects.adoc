...
---
= Resuelve la alerta de objetos potencialmente perdidos en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Es posible que el soporte técnico te pida que compruebes si hay algún procedimiento de recuperación del almacenamiento en curso. Consulta:
