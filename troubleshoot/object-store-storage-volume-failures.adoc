...
---
= Conoce los fallos del almacén de objetos para volúmenes de almacenamiento en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:nodes_page_storage_nodes_storage_tables.png["Tablas de almacenamiento del nodo de página nodos"]
