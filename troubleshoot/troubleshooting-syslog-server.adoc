...
---
= Soluciona los mensajes de error del servidor syslog externo para StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:../monitor/configure-log-management.html["Configurar la gestión de registros y el servidor syslog externo"]
