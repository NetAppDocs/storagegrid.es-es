...
. Si el inicio de sesión único (SSO) está activado para el sistema StorageGRID, consulte los pasos para link:../admin/configure-sso.html["configuración del inicio de sesión único"].
+
