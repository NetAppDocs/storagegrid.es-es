...
---
= Soluciona problemas del nodo de administración y de la interfaz de usuario en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Si el inicio de sesión único (SSO) está habilitado para tu sistema StorageGRID, consulta cómo configurar el SSO usando link:../admin/learn-about-setting-up-sso-oidc.html["OIDC"] o link:../admin/learn-about-setting-up-sso-saml.html["SAML"].
+
...
... Selecciona *Probar conexión* para validar la configuración de tu conexión con el servidor LDAP.
