...
---
= Soluciona problemas de red, hardware y plataforma en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Crea interfaces de red virtuales independientes para que las utilice el sistema operativo anfitrión de Linux. Usar las mismas interfaces de red para el sistema operativo anfitrión de Linux y el contenedor de StorageGRID podría hacer que el sistema operativo anfitrión quede inaccesible.
