...
* link:../monitor/manually-triggering-autosupport-package.html["Active manualmente un paquete AutoSupport"]
...
[cols="1a,2a,4a"]
|===
| image:feature_checkmark.gif["marca de verificación"] | Elemento | Notas 
