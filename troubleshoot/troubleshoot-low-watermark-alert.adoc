...
---
= Resuelve la alerta de anulación de marca de agua en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:nodes_page_object_data_used_with_alert.png["Página Nodes donde se muestran los datos del objeto que se usan para 3 SNS"]
...
.. Desplázate hacia abajo hasta la tabla de almacenes de objetos.
