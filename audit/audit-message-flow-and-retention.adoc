...
image:audit_message_flow.gif["Diagrama que resume el flujo de mensajes de auditoría a través de relés"]
...
image:audit_message_retention.gif["Diagrama que resume la recepción de mensajes de auditoría en AMS"]
