...
summary: 'Puedes utilizar la herramienta audit-sum para contar los mensajes de auditoría de escritura, lectura, head y eliminación, y para consultar el tiempo (o tamaño) mínimo, máximo y promedio de cada tipo de operación.' 
---
