...
Para obtener información sobre la configuración de niveles de mensajes de auditoría y el uso de un servidor syslog externo, consulte link:../monitor/configure-audit-messages.html["Configure los mensajes de auditoría y el servidor de syslog externo"].
