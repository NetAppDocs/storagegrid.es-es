...
summary: 'Este mensaje se genera cuando una operación externa (solicitada por el cliente) hace que un objeto sea sobrescrito por otro objeto.' 
---
= Mensaje de auditoría OVWR para sobrescrituras de objetos en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
