...
summary: El mensaje de auditoría LKDM se genera cuando se ha limpiado o eliminado un fragmento filtrado. 
---
= Mensaje de auditoría LKDM para limpieza de objetos filtrados en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
