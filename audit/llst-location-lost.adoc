...
summary: 'Este mensaje se genera cada vez que no se encuentra una ubicación para una copia de un objeto (replicada o con código de borrado).' 
---
= Mensaje de auditoría LLST para ubicaciones de copias de objetos perdidas en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
