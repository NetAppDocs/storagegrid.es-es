...
summary: Cuando un cliente de Swift emite una operación HEAD, se solicita que compruebe si existe una cuenta, un contenedor o un objeto, y recupere los metadatos relevantes. Este mensaje lo emite el servidor si la operación se realiza correctamente. 
---
...
[role="lead"]
Cuando un cliente de Swift emite una operación HEAD, se solicita que compruebe si existe una cuenta, un contenedor o un objeto, y recupere los metadatos relevantes. Este mensaje lo emite el servidor si la operación se realiza correctamente.
...
Código de resultado
 a| 
Resultado de la operación DEL CABEZAL. El resultado es siempre:
