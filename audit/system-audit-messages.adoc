...
summary: 'Los mensajes de auditoría que pertenecen a la categoría de auditoría del sistema se utilizan para eventos relacionados con el propio sistema de auditoría, los estados de los nodos de la cuadrícula, la actividad de tareas en todo el sistema (tareas de grid) y las operaciones de copia de seguridad de servicio.' 
---
= Mensajes de auditoría para eventos del sistema en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
