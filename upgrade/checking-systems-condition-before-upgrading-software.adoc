...
---
= Revisa el estado de tu sistema StorageGRID antes de actualizar
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Consulta link:../network/internal-grid-node-communications.html["Comunicaciones internas de los nodos de grid"] y link:../network/external-communications.html["Comunicaciones externas"] para asegurarte de que todos los puertos necesarios para StorageGRID 12.1 estén abiertos antes de realizar la actualización.
+

NOTE: No se necesitan puertos adicionales al actualizar a StorageGRID 12.1.
