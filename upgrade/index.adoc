...
Revisa estos temas para conocer las nuevas funciones y mejoras de StorageGRID 12.1, determinar si alguna función ha quedado obsoleta o se ha eliminado, y enterarte de los cambios en las API de StorageGRID.

* link:how-your-system-is-affected-during-upgrade.html["Cómo se ve afectado el sistema durante la actualización"]
* link:../release-notes/whats-new.html["Novedades de StorageGRID 12.1"]
* link:../release-notes/removed-or-deprecated-features.html["Operaciones eliminadas o obsoletas"]
* link:../release-notes/changes-to-grid-management-api.html["Cambios en la API de gestión de grid"]
* link:../release-notes/changes-to-tenant-management-api.html["Cambios en la API de gestión de inquilinos"]
