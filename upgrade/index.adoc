...
Revise estos temas para saber más sobre las nuevas funciones y mejoras que se han aplicado en StorageGRID 12,0, determine si alguna función se ha obsoleto o se ha eliminado y obtenga información sobre los cambios en las API de StorageGRID.
