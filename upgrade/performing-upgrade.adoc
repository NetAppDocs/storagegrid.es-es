...
summary: Puedes actualizar a StorageGRID 12.1 y aplicar al mismo tiempo la última corrección urgente para esa versión. La página de actualización de StorageGRID ofrece la ruta de actualización recomendada y enlaces directos a las páginas de descarga correspondientes. 
---
= Realiza una actualización de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes actualizar a StorageGRID 12.1 y aplicar al mismo tiempo la última corrección urgente para esa versión. La página de actualización de StorageGRID ofrece la ruta de actualización recomendada y enlaces directos a las páginas de descarga correspondientes.
...
La ruta de actualización que aparece en la página «Actualización de StorageGRID» indica qué versiones principales (por ejemplo, 12.1.0) y correcciones urgentes (por ejemplo, 12.1.0.1) debes instalar para llegar a la última versión de StorageGRID. Debes instalar las versiones y correcciones urgentes recomendadas en el orden indicado.
...
. Selecciona *Examinar* para cargar el archivo de actualización de versión en StorageGRID: `NetApp_StorageGRID_12.1.0_Software_uniqueID.upgrade`
+
...
. Revisa los detalles de cada comprobación previa notificada y resuelve los errores detectados. Consulta el  https://kb.netapp.com/hybrid/StorageGRID/Maintenance/StorageGRID_12.1_software_upgrade_resolution_guide["Guía de resolución de actualización de software StorageGRID"^] para la versión 12.1 de StorageGRID.
+
...
NOTE: Para una actualización a StorageGRID 12.1, si quieres aprobar nodos individuales en lugar de todos los nodos, la mejor práctica es actualizar un sitio completo antes de pasar al siguiente sitio.
...
.Pasos
. En cuanto se haya completado la tarea *Habilitar funciones* (lo que puede tardar hasta una hora), puedes empezar a usar el link:whats-new.html["otras nuevas"] en la versión actualizada de StorageGRID.
+
