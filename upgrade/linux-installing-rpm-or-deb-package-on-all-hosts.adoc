...
---
= Descarga e instala paquetes RPM o DEB en todos los hosts Linux para StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. La verificación de la firma del código es manual en un nodo Linux.  Opcionalmente, verifique el archivo de instalación:
+
...
.. Siga los pasos paralink:../swnodes/download-files-verify.html["verifique manualmente los archivos de instalación"] .
...
+
Consulte los pasos para instalar los servicios de host de StorageGRID para Linux enlink:../swnodes/installing-storagegrid-webscale-host-services.html["Instale los servicios de host StorageGRID"] .
