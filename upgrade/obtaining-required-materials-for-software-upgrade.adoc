...
---
= Obtén los materiales necesarios para una actualización de software de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Documentación de StorageGRID
 a| 
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3373065["Notas de la versión"^]. Debes iniciar sesión con tu cuenta de NetApp o crear una cuenta para acceder a las notas de la versión. Asegúrate de leerlas detenidamente antes de empezar la actualización.
* https://kb.netapp.com/hybrid/StorageGRID/Maintenance/StorageGRID_12.1_software_upgrade_resolution_guide["Guía de resolución de actualización de software StorageGRID"^] para la versión principal a la que vas a actualizar (es necesario iniciar sesión)
