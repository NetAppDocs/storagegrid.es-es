...
summary: 'Para gestionar objetos, debe crear un conjunto de reglas de gestión de ciclo de vida de la información (ILM) y organizarlas en una política de ILM.' 
---
...
image:ilm_rule_multiple_placements_in_single_time_period.png["Pantalla de ubicaciones de ILM en Grid Manager"]

La primera instrucción de asignación image:icon_number_1.png["Icono número 1"] tiene dos líneas para el primer año:
...
La segunda instrucción de asignación image:icon_number_2.png["Icono número 1"] crea dos copias al cabo de un año y las conserva indefinidamente.
