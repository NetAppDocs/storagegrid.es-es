...
.Resultados
Cualquier modificación en las reglas de la política se reflejará en los resultados de la simulación y mostrará la nueva coincidencia y la coincidencia anterior. La ventana Simular policy conserva los objetos que probaste hasta que selecciones *Clear all* o el icono de eliminar image:icon-x-to-remove.png["Icono Eliminar"] para cada objeto en la lista de resultados de la simulación.
