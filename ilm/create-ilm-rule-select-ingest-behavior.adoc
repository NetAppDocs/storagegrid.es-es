...
summary: 'El paso 3 (Seleccionar comportamiento de ingesta) del asistente para crear una regla ILM te permite elegir cómo se protegen los objetos filtrados por esta regla en el momento de su ingesta.' 
---
