...
image:ilm_replication_make_1_copy.png["Replicación de ILM haga 1 copia"]
...
image:ilm_replication_make_1_copy_sn_fails.png["Error en la replicación ILM Make 1 Copy SN"]
...
image:ilm_replication_make_2_copies_sn_fails.png["La replicación de ILM hace 2 copias SN da error"]
