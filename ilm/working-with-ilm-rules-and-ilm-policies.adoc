...
+
image:ilm_rule_details_page.png["Página de detalles de reglas de ILM"]
...
+
Puedes hacer clic en el signo de interrogación image:icon_nms_question.png["icono de signo de interrogación"] para ver una descripción de los elementos de la pestaña ILM.

+
image:ilm_metrics_on_dashboard.png["Métricas de ILM en la consola de Grid Manager"]
