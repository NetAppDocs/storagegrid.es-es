...
image:ilm_rule_two_copies_two_data_centers.png["Regla ILM 1 Por ejemplo 1: Copiar datos de objetos en dos sitios"]
...
|===
image:ilm_rule_ec_for_s3_bucket_finance_records.png["Regla de ILM 2 Por ejemplo 1: Perfil de código de borrado con coincidencia de bloques"]
...
+
image:policy_1_configured_policy.png["Política de ILM, por ejemplo 1"]
