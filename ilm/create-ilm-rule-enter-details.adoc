...
summary: 'El paso 1 (Introducir datos) del asistente para crear una regla de ILM te permite introducir un nombre y una descripción para la regla y definir filtros para la regla.' 
---
...
image:advanced_filtering_size_between.png["Ejemplo de filtrado avanzado para el tamaño del objeto"]
...
image:advanced_filtering_multiple_rows.png["Ejemplo de filtrado avanzado para metadatos de usuario"]
