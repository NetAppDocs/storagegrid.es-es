...
+
.. Para cada nivel de almacenamiento personalizado que quieras añadir, selecciona *Insert* image:icon_nms_insert.gif["insertar icono"] para añadir una fila.
.. Introduzca una etiqueta descriptiva.
+
image:editing_storage_grades.gif["Página Storage Grades"]

.. Seleccione *aplicar cambios*.
.. Si lo deseas, si necesitas modificar una etiqueta guardada, selecciona *Editar* image:icon_nms_edit.gif["icono editar"] y selecciona *Aplicar cambios*.
+
...
+
.. Busca el nodo de almacenamiento en la lista LDR y selecciona su icono *Editar* image:icon_nms_edit.gif["icono editar"].
.. Seleccione el grado de almacenamiento adecuado en la lista.
+
image:assigning_storage_grades_to_storage_nodes.gif["Página Storage Grades"]
