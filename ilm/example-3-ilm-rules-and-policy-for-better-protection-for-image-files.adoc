...
|===
image:policy_3_rule_1_ec_images_adv_filtering.png["Regla ILM 1 por ejemplo 3: Utilice EC para archivos de imagen superiores a 1 MB"]
...
image:policy_3_configured_policy.png["Política de ILM, por ejemplo 3: Mejor protección para los archivos de imagen"]
