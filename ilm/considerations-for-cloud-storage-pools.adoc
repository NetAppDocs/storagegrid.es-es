...
No utilices la gestión del ciclo de vida de Azure Blob Storage para el contenedor que se utiliza con un Cloud Storage Pool. Las operaciones del ciclo de vida podrían interferir con las operaciones de Cloud Storage Pool.
