...
image:ec_three_sites_4_plus_2.png["Código de borrado tres sitios 4 más 2"]
...
image:ec_recoverable_4_plus_2.png["Código de borrado recuperable 4 Plus 2"]

Si se pierden más de dos nodos de almacenamiento, el objeto no se puede recuperar.

image:ec_unrecoverable_4_plus_2.png["Código de borrado irrecuperable 4 Plus 2"]
