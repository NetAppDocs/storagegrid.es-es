...
summary: Cuando creas una regla de ILM, puedes proteger los objetos al momento de la ingesta especificando Dual commit, Strict o Balanced. 
---
...
image:ingest_object_lifecycle.png["Diagrama que muestra cómo se produce la ingesta de objetos para cada opción de ingesta"]
