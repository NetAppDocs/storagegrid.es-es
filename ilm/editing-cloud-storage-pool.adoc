...
summary: Puedes editar un grupo de almacenamiento en la nube para cambiar su nombre, el punto final del servicio u otros detalles. Sin embargo, no puedes cambiar el bucket de S3 ni el contenedor de Azure de un grupo de almacenamiento en la nube. 
---
