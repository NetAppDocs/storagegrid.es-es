...
== Requisitos para poder activar S3 Object Lock en buckets existentes

Cuando la configuración global de S3 Object Lock está habilitada, puedes, si lo deseas, permitir que todas las cuentas de inquilino de S3 o los usuarios de S3 con permisos habiliten S3 Object Lock en los buckets existentes. Cuando una cuenta de inquilino de S3 o un usuario de S3 habilita S3 Object Lock en un bucket existente, esto podría provocar una migración involuntaria de datos desde un Cloud Storage Pool de vuelta a StorageGRID, dependiendo de tus reglas de ILM.


CAUTION: No puedes detener la migración involuntaria de datos una vez que comienza.
