...
NOTE: Al instalar StorageGRID 12.0 o una versión posterior en una nueva red, se crean automáticamente grupos de almacenamiento para cada sitio. Sin embargo, si inicialmente instalaste StorageGRID 11.6 o una versión anterior, los grupos de almacenamiento no se crean automáticamente para cada sitio.
...
+
Para eliminar una entrada, selecciona el icono de eliminación image:icon_x_to_remove.png["icono de eliminar"].
