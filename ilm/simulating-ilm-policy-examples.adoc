...
image:simulate_policy_screen.png["Simular resultados de políticas"]
...
+
image:simulate_reorder_rules_pngs_result.png["Ejemplo 2: Reordenar reglas al simular una política de ILM"]
...
+
image:simulate_reorder_rules_correct_result.png["Ejemplo 2: Reordenar reglas al simular una política de ILM"]
...
image:simulate_results_for_object_wrong_metadata.png["Ejemplo 3: Corrección de una regla al simular una política de ILM"]
...
+
image:simulate_results_for_object_corrected_metadata.png["Ejemplo 3: Corrección de una regla al simular una política de ILM"]
