...
image:ilm_rule_apply_only_to_older_object_verions.png["Aplique la regla de ILM solo a las versiones de objetos más antiguas (hora no actual)."]
...
link:how-objects-and-delete-markers-are-deleted.html["Cómo se eliminan los objetos y los marcadores de eliminación"]
