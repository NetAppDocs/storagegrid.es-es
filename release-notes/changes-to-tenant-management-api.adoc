...
summary: StorageGRID 12.0 utiliza la versión 4 de la Tenant Management API. La versión 4 deja obsoleta la versión 3. Sin embargo, las versiones 1, 2 y 3 siguen siendo compatibles. 
---
