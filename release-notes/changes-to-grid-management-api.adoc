...
summary: StorageGRID 12.0 utiliza la versión 4 de la API de gestión de Grid. La versión 4 sustituye a la versión 3. No obstante, las versiones 1, 2 y 3 siguen siendo compatibles. 
---
