...
sidebar: sidebar 
keywords:  
summary: Conoce las características y capacidades que han sido eliminadas o desaprobadas en StorageGRID 12.0. Antes de actualizar, revisa si alguna característica eliminada o desaprobada afecta a tus aplicaciones cliente o a la configuración de tu grid. 
---
...
[role="lead"]
Conoce las características y capacidades que han sido eliminadas o desaprobadas en StorageGRID 12.0. Antes de actualizar, revisa si alguna característica eliminada o desaprobada afecta a tus aplicaciones cliente o a la configuración de tu grid.
