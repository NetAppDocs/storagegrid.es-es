...
Si estás configurando puntos finales del equilibrador de carga para un link:../admin/configure-global-namespace.html["espacio de nombres global"], utiliza el mismo puerto para cada punto final.
...
+
image:load_balancer_endpoint_details.png["Detalles del punto final del equilibrador de carga"]
...
.. Selecciona el icono de edición image:icon_edit_tm.png["Icono Editar"].
.. Introduzca el nuevo nombre.
.. Seleccione *Guardar*.
