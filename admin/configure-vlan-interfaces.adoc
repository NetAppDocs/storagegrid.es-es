...
summary: 'Puedes crear interfaces de red local virtual (VLAN) en los nodos de administración y en los nodos de puerta de enlace y usarlas en grupos de alta disponibilidad y puntos finales de balanceador de carga para aislar y dividir el tráfico por seguridad, flexibilidad y rendimiento.' 
---
= Configura interfaces VLAN en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:vlan-create-parent-interfaces.png["Interfaces principales del asistente de creación de VLAN"]
...
** Si necesitas eliminar una interfaz principal, selecciona el icono de la papelera image:icon-trash-can.png["icono de papelera"].
