...
+
image:vlan_create_parent_interfaces.png["Interfaces principales del asistente de creación de VLAN"]
...
** Si necesitas eliminar una interfaz principal, selecciona el icono de la papelera image:icon_trash_can.png["icono de papelera"].
