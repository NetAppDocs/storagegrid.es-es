...
---
= Crear aplicaciones empresariales en Entra ID para SAML en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Utiliza Entra ID para crear una aplicación empresarial para cada Admin Node de SAML en tu sistema.
...
== Paso 2: crea aplicaciones empresariales y guarda la configuración de SSO de StorageGRID
...
== Paso 3: Descarga los metadatos SAML de cada nodo de administración
...
== Paso 4: Sube los metadatos SAML a cada aplicación empresarial
...
. link:../admin/configure-sso-saml.html#test-sso["Pruebe cada aplicación"].
