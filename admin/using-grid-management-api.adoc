...
.Pasos
. En la barra de encabezado de Grid Manager, selecciona el icono de ayuda image:icon_help_menu_bar.png["Icono de ayuda"] y elige *Documentación de la API*.
...
+
image:swagger_example.png["Ejemplo de interfaz de usuario de Swagger"]
