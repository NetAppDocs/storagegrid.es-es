...
---
= Eliminar una cuenta de inquilino de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Si se permite al inquilino utilizar conexiones de federación de grid, ya revisaste las consideraciones para link:../admin/grid-federation-manage-tenants.html["Eliminación de un inquilino con el permiso de conexión Usar federación de grid"]. Las eliminaciones se sincronizan, así que si se elimina un inquilino en cualquier grid, se eliminará en todos los grids seleccionados.
