...
---
= Entrega por sitio de mensajes de servicios de plataforma StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:notification_multiple_sites.gif["El diagrama que muestra la acción en el objeto en el sitio 1 activa la notificación desde el sitio 1"]
...
image:notifications_site_2.gif["el diagrama que muestra la acción en el objeto del sitio 2 activa las notificaciones del sitio 2"]
