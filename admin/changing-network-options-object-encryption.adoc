...
NOTE: A partir de StorageGRID 12.1.0, la compatibilidad con el cifrado AES-128 de los nuevos datos de objetos almacenados en reposo está obsoleta. La compatibilidad para la recuperación de objetos almacenados que se cifraron originalmente con AES-128 continúa.
