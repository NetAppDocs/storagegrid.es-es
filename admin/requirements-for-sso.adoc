...
StorageGRID es compatible con varios proveedores de identidad (IdP) de inicio de sesión único (SSO).

[role="tabbed-block"]
====
.OIDC
--
Se admiten los siguientes SSO IdPs para OpenID Connect (OIDC):
...
.SAML
--
Se admiten los siguientes SSO IdPs para el Lenguaje de Marcado de Afirmaciones de Seguridad 2.0 (SAML 2.0):
