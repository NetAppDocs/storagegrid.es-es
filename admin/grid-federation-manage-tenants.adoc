...
+
image:grid-federation-tenant-detail.png["federación de grid en la página de detalles de inquilino"]
...
image:grid-federation-remove-permission.png["pasos para eliminar la conexión de federación de grid"]
...
+
image:grid-federation-remove-permission-error.png["se muestra un mensaje de error si el inquilino tiene cgr activado para un depósito"]
