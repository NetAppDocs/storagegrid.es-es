...
---
= Conoce las marcas de agua de los volúmenes de almacenamiento en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:storage_volume_watermarks.png["Marcas de agua de volumen de almacenamiento"]
