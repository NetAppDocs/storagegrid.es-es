...
summary: 'StorageGRID utiliza una autoridad de certificación (CA) interna para proteger el tráfico interno. Este certificado no cambia aunque subas tus propios certificados.' 
---
= Copia el certificado StorageGRID Grid CA
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
