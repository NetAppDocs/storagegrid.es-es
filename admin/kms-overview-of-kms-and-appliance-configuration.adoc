...
summary: 'Antes de que puedas usar un servidor de gestión de claves (KMS) para proteger los datos de StorageGRID en los nodos del dispositivo, debes configurar uno o más servidores KMS y habilitar el cifrado de nodos para los nodos del dispositivo. Cuando estas dos tareas de configuración estén completas, el proceso de gestión de claves ocurre automáticamente.' 
---
...
image:kms_configuration_overview.png["Flujo de trabajo de configuración de KM, que se describe en el siguiente texto"]
