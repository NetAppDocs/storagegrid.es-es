...
summary: 'Antes de que puedas usar un servidor de gestión de claves (KMS) para proteger los datos de StorageGRID en los nodos de appliance, debes completar dos tareas de configuración: configurar uno o más servidores KMS y habilitar el cifrado de nodo para los nodos de appliance. Cuando estas dos tareas de configuración estén completas, el proceso de gestión de claves ocurre automáticamente.' 
---
