...
summary: 'Antes de configurar un servidor de gestión de claves (KMS) externo, debe comprender las consideraciones y los requisitos.' 
---
...
image:kms_per_site.png["KMS por sitio"]
