...
summary: Si falla un intento de enviar un paquete AutoSupport, el sistema StorageGRID toma diferentes acciones según el tipo de paquete AutoSupport. 
---
= Soluciona problemas de los paquetes StorageGRID AutoSupport
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
