...
+
image:grid-federation-retry-account-clone.png["Captura de pantalla que muestra un mensaje de error y el botón Reintentar clon de cuenta"] Si el error se ha solucionado, la cuenta del tenant ahora se clonará en la otra grid.
...
image:grid-federation-last-error.png["Captura de pantalla que muestra un mensaje en la última columna de error de una conexión de federación de cuadrícula"]
