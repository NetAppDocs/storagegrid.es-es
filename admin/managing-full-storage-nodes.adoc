...
summary: A medida que los nodos de almacenamiento alcanzan su capacidad, debes ampliar el sistema StorageGRID agregando nuevo almacenamiento. Puedes hacerlo añadiendo volúmenes de almacenamiento, bandejas de expansión de almacenamiento y nodos de almacenamiento. 
---
