...
summary: 'A medida que los nodos de almacenamiento alcancen su capacidad máxima, debes ampliar el sistema StorageGRID añadiendo nuevo almacenamiento. Hay tres opciones disponibles: añadir volúmenes de almacenamiento, añadir bandejas de expansión de almacenamiento y añadir nodos de almacenamiento.' 
---
= Gestiona nodos de almacenamiento completos en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
