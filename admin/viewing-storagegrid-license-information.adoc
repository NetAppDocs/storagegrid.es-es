...
image:dashboard_health_panel_license_status.png["Estado de la licencia de la tarjeta de estado del panel de control"]
...
+
Esta fecha se lee del archivo de licencia actual y puede estar desactualizada si ampliaste o renovaste el contrato de servicio de soporte después de obtener el archivo de licencia. Para actualizar este valor, consulta link:updating-storagegrid-license-information.html["Actualice la información de licencia de StorageGRID"]. También puedes ver la fecha real de finalización del contrato usando Digital Advisor.
