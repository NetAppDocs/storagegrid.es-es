...
---
= Compara la replicación entre grids y la replicación CloudMirror en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Agrega nuevas cuentas de inquilino, que se sincronizan automáticamente con la otra grid.
. Agrega nuevos grupos de inquilinos y usuarios, que también se sincronizan.
