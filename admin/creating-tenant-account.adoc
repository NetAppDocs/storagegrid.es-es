...
Usar origen de identidad propio
 a| 
El inquilino puede configurar y gestionar su propio origen de identidad para usuarios y grupos federados. Esta opción estará deshabilitada si link:../admin/how-sso-works.html["SSO configurado"]tiene para el sistema StorageGRID.
