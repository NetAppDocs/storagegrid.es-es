...
---
= Consideraciones y requisitos del asistente de configuración de StorageGRID S3
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
--
Si tienes pensado utilizar solicitudes de S3 con alojamiento virtual, debes tener link:../admin/configuring-s3-api-endpoint-domain-names.html["Nombres de dominio de punto final S3 configurados"]. Se recomienda utilizar solicitudes con alojamiento virtual.
...
--
Configure cualquier conexión de federación de grid:: Si deseas permitir que el inquilino de S3 sincronice los datos de la cuenta y replique los objetos del bucket en otra grid mediante una conexión de federación de grids, comprueba lo siguiente antes de iniciar el asistente:
+
--
