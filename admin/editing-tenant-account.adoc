...
---
= Editar una cuenta de inquilino de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
... Selecciona la pestaña Grid federation en la página de detalles del inquilino.
... Selecciona la conexión que deseas eliminar.
