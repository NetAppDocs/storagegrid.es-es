...
*** link:creating-relying-party-trusts-in-ad-fs-saml.html#create-a-relying-party-trust-manually["Especifique manualmente un certificado SSO para una confianza de parte de confianza"]
