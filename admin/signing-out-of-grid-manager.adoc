...
*Nota:* Si SSO está habilitado y usted también ha iniciado sesión en el Gestor de Inquilinos, también debe link:../tenant/signing-out-of-tenant-manager.html["cierre la sesión de la cuenta de inquilino"]hacerlolink:how-sso-works.html["Cierre la sesión de SSO"].
