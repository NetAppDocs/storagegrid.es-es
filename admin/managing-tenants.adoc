...
summary: 'Una cuenta de inquilino permite usar la API DE REST DE Simple Storage Service (S3) para almacenar y recuperar objetos en un sistema StorageGRID.' 
---
= Cuentas de tenant en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Utiliza la federación de grid para la sincronización de cuentas y la replicación entre grids
