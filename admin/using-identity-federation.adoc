...
* Si tiene pensado activar el inicio de sesión único (SSO), ha revisado el link:requirements-for-sso.html["requisitos y consideraciones para el inicio de sesión único"].
