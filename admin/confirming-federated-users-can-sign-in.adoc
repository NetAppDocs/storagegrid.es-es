...
summary: 'Antes de habilitar el inicio de sesión único (SSO), debe confirmar que al menos un usuario federado puede iniciar sesión en Grid Manager y en el Gestor de inquilinos para cualquier cuenta de inquilino existente.' 
---
= Confirma que los usuarios federados pueden Sign in en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
