...
** Selecciona el icono de copiar (image:icon_tenant_copy_url.png["icono de copia"]) para copiar el ID de la clave de acceso y la clave secreta de acceso en el portapapeles.
