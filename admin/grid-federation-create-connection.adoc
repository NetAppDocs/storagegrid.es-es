...
summary: Puedes crear conexiones de federación de red entre sistemas StorageGRID si quieres sincronizar los detalles de los inquilinos y replicar los datos de los objetos. 
---
= Crear conexiones de federación de grid StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes crear conexiones de federación de red entre sistemas StorageGRID si quieres sincronizar los detalles de los inquilinos y replicar los datos de los objetos.
...
TIP: Opcionalmente, puedes link:../admin/grid-federation-automate-connections.html["automatiza la creación, edición y mantenimiento de las conexiones de grid federation"].

image:grid_federation_create_connection.png["descripción gráfica de los pasos para crear una conexión en dos cuadrículas"]
...
. Introduce un nombre de conexión, que debe ser único para que puedas reconocer esta conexión. Por ejemplo, `Grid 1-Grid 2`.
. Si quieres link:../admin/configure-global-namespace.html["configurar un espacio de nombres global"], selecciona *Habilitar espacio de nombres global*.
. Seleccione *continuar*.
. Introduce los datos de la cuadrícula de la siguiente manera:
...
* link:grid-federation-troubleshoot.html["Solucione los problemas de la conexión"], incluida la resolución de cualquier alerta o error relacionado con la sincronización de cuentas y la replicación entre grids.
