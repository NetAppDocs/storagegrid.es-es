...
summary: 'Si envía paquetes AutoSupport mediante HTTP o HTTPS, puede configurar un servidor proxy no transparente entre los nodos de administración y el soporte técnico (AutoSupport).' 
---
= Configura los ajustes del proxy de administración en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para obtener más información sobre AutoSupport, consulta link:../monitor/configure-autosupport-grid-manager.html["Configure AutoSupport"].
