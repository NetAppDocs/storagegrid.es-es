...
image:grid-federation-workflow.png["Flujo de trabajo de conexión de federación de grid"]
...
+
Para obtener más información sobre los requisitos de versión, consulta la  https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["Notas de la versión"^]. Debes iniciar sesión con tu cuenta de NetApp o crear una cuenta para acceder a las notas de la versión.
...
image:grid-federation-certificates.png["Certificados de federación de grid"]
