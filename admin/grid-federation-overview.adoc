...
summary: Puedes utilizar la federación de grid para sincronizar los tenants y replicar sus objetos entre varios sistemas StorageGRID para recuperación ante desastres. 
---
= Conoce la federación de grid de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Puedes utilizar la federación de grid para sincronizar los tenants y replicar sus objetos entre varios sistemas StorageGRID para recuperación ante desastres.
...
image:grid_federation_workflow.png["Flujo de trabajo de conexión de federación de grid"]
...
+
Para obtener más información sobre los requisitos de versión, consulta la  https://library.netapp.com/ecm/ecm_download_file/ECMLP3373065["Notas de la versión"^]. Debes iniciar sesión con tu cuenta de NetApp o crear una cuenta para acceder a las notas de la versión.
...
* Debe existir al menos una conexión de federación de grid antes de que puedas usar link:grid-federation-what-is-account-sync.html["sincronización de cuentas"] o link:grid-federation-what-is-cross-grid-replication.html["replicación entre grid"].
...
image:grid_federation_certificates.png["Certificados de federación de grid"]
