...
---
= Políticas de clasificación de tráfico en StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
En el caso de los límites de ancho de banda de agregado o por solicitud, las solicitudes entran o salen a la velocidad que tú establezcas. StorageGRID solo puede aplicar una velocidad, así que la política más específica, según el tipo de comparador, es la que se aplica. El ancho de banda consumido por la solicitud no cuenta para otras políticas coincidentes menos específicas que incluyan políticas de límite de ancho de banda de agregado. Para todos los demás tipos de límite, las solicitudes de los clientes se retrasan 250 milisegundos y reciben una respuesta 503 Slow Down para las solicitudes que superen cualquier límite de las políticas coincidentes.

En el Grid Manager, puedes consultar los gráficos de tráfico y comprobar que las políticas están aplicando los límites de tráfico que esperas.
