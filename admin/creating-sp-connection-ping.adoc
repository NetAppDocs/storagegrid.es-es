...
* Tiene el *ID de conexión SP* para cada nodo de administración de su sistema. Puede encontrar estos valores en la tabla de detalles Nodos de Administración de la página Configurar SSO.
...
* Tiene el link:../admin/admin-group-permissions.html["Permiso de administrador"]servidor FOR PingFederate.
...
. Seleccione el archivo de metadatos de SAML que descargó de la página Configurar SSO para el nodo de administración.
