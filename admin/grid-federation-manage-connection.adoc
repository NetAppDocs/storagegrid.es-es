...
---
= Administra las conexiones de la federación de grid de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Mientras se edita la conexión, las solicitudes de sincronización de cuentas o de replicación entre grids seguirán utilizando la configuración de conexión existente. Debes editar una conexión a la vez y cargar un archivo de verificación en el grid remoto para cada conexión. Los cambios se aplican después de que se han cargado en los grids remotos.
...
image:grid_federation_remove_connection.png["pasos para eliminar la conexión de federación de grid"]
